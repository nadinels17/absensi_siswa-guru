...
require "../admin1/config/connection.php";
$query = mysqli_query($conn, "SELECT * FROM absensi_murid JOIN tb_kelas ON absensi_murid.id_kelas =
                                            tb_kelas.id_kelas JOIN siswa_smkn12 ON 
                                            absensi_murid.id_siswa = siswa_smkn12.id_siswa");
$no = 1;
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <main>
                ...
                <h3 class="input-absensiswa"><b>ABSENSI SISWA TERBARU</b></h3>
