...
if (isset($_POST["search"])) {
    ...
    INNER JOIN siswa_smkn12 ON absensi_murid.id_siswa = siswa_smkn12.id_siswa WHERE tanggal BETWEEN '$tanggal_awal_formatted' AND '$tanggal_akhir_formatted'");
}

$query1 = mysqli_query($conn, "SELECT * FROM absensi_murid JOIN tb_kelas ON absensi_murid.id_kelas = tb_kelas.id_kelas
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <main>
                ...
                <h3 class="input-absensiswa text-center"><a href="absensi_guru.php" class="text-dark"><i
                            class="bi bi-caret-left ms-5"></i></a> ABSENSI SISWA </h3>
                ...
                <div class="container">
                    ...
                    <div class="row-1 mt-5">
                        <form class="d-flex" method="post" action="absensi_guru.php">
                            ...
                            <a href="excelabsensiswa.php" name="export" class="btn btn-danger excel">EXPORT TO EXCEL</a>
                        </form>
                    </div>
